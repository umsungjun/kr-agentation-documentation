...
export function TextSelectionDemo() {
  ...
  const actualCursorX = isSelecting
    ...
    <div className="tsd-container">
      ...
      <div className="tsd-content">
        ...
        <p className="tsd-article-text">
          You will recieve a confirmation email shortly after signing up for our
          newsletter. Please check your inbox and follow the instructions to
          complete your subscription. We send weekly updates with the latest
          articles and tips.
        </p>
        ...
        <div
          className={`tsd-cursor ${isSelecting ? 'selecting' : ''}`}
